...
export const UnderImplementation = () => {
  return (
    <div>
      <div className="mt-10 mr-10 ml-10 mb-10">
        <div className="navbar bg-white">
          <div className="navbar-start ">
            <span className="mission-type">مهمة تسكين مزرعة</span>
          </div>
        ...
        <div className="mission-title bg-white">مهمة اضافة مزرعة في الجيزة</div>
        <div className="navbar bg-white">
          <div className="navbar-start">
            <div className="price-section">السعر 100 جنيه</div>
          ...
          <div className="navbar-end">
            <div className="underimplment-btn">مهمة تحت التنفيذ</div>
            <div className="assigned-to">
              <img src={avatar} alt="avatar" className="avatar-mission" />
              <span className="relative assign-text">اسند لي</span>
              <span className="relative assign-user">محمد حسين</span>
            </div>
          </div>
        </div>
      </div>
